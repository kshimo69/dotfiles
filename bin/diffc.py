...
"""Minor modifications made by Alex Louden
"""

"""
The binary was auto-generated from the src/ files. Please see 
...
class Diffc:
    ...
    def color(self, input):
        ...
        for line in input:
            if self.is_info(line) or line.startswith('==='):
                output += self.calc_word_diff()
                output += [ self.color_info + line + Color.DEFAULT ]
                continue

            if line.startswith('+++'):
              output += [ self.color_right_context + line + Color.DEFAULT ] # TODO
              continue
              
            if line.startswith('---'):
              output += [ self.color_left_context + line + Color.DEFAULT ] # TODO
              continue
